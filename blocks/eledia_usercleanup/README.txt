...
Set how often the process should start (days), the number of days since last login to mark the user as inactive and the number of days after the notify mail until he gets deleted.
